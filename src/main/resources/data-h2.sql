/* INSERT MEMBER */
INSERT INTO member (ID, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_EMAIL, ROLE) values ((select next value for hibernate_sequence), 'test123', '고건주', 'gunjuko92@gmail.com', 'ADMIN');
INSERT INTO member (ID, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_EMAIL, ROLE) values ((select next value for hibernate_sequence), 'test123', '김민환', 'minhwan@gmail.com', 'USER');
